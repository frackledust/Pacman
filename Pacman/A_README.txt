...
Seznam souborů:
    ...
    /pac_game.c - obsahuje funkce obsažené v mainu (iniciace hry, update, render, free)
    /pac_input.c  - nahrání hracího pole z txt souboru
    /pac_board.c - funkce na interakce s hrací plochou
    /pac_eater.c - funkce ovládající pacmana samotného
    /pac_ghost.c - funkce ovládající duchy
...
2) pohyb pacmana na mapě        - hra se spustí stisknutím klávesy SPACE
